...
def app():
   ...
   # frequency of each car feature
    ...
    features = left_col.selectbox("Which feature would you like to compare ", options=[
        'Body_Type', 'Fuel_Type', 'Drivetrain', 'Engine_Type', 'Cylinders', 'Seating_Capacity'], index=2)
